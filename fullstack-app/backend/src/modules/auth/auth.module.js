...
var user_schema_1 = require("../shemas/user.schema");
// @Module({
//   imports: [
//     MongooseModule.forFeature([{ name: User.name, schema: UserSchema }]), // Подключение модели пользователя
//   ],
    ...
    var _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                jwt_1.JwtModule.register({
                    secret: process.env.JWT_SECRET || 'defaultSecret', // Храните секрет в .env
